...
document.querySelectorAll('.faq h3').forEach((faqHeader) => {
    ...
    // Example: Expand/Collapse Resource Hub Section
    document.addEventListener("DOMContentLoaded", () => {
        ...
        toggleButton.addEventListener("click", () => {
            const isHidden = resourceHub.style.display === "none";
            resourceHub.style.display = isHidden ? "block" : "none";
        });

        // Insert the toggle button above the section
